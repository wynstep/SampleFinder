  ...
  <div class="container" id="ccle_results">
    ...
    <div id="copy_number_alterations">
      ...
      <div class='cna_ccle' id='cna_ccle'>
        <iframe class='results' id='cna_hm'></iframe>
...
EOT;
      ...
      foreach ($all_specimens as &$specimen) {
        if ($cont_specimen==0) {
          echo "<td style=\"padding-right:10px; font-size: 12px;\"><input type=\"radio\" name=\"selector\" checked onclick=LoadNetworkGraph('".$ac."','".$cont_specimen."'); />".$specimen."</td>";
        } else {
          echo "<td style=\"padding-right:10px; font-size: 12px;\"><input type=\"radio\" name=\"selector\" style=\"margin-right:10px;\" onclick=LoadNetworkGraph('".$ac."','".$cont_specimen."'); />".$specimen."</td>";
        }
        $cont_specimen++;
      }
